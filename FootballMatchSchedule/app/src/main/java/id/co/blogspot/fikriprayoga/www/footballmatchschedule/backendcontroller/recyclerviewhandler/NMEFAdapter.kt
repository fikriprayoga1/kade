...
class NMEFAdapter(internal var context: Context
                 , internal var nmefObject: List<NMEFObject>
                 , internal var nmefListener: NMEFListener) : RecyclerView.Adapter<NMEFAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val mNMFObject = nmefObject[position].Data
