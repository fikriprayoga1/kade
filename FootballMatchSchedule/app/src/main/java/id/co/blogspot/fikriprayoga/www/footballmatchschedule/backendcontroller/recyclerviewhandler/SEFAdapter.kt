...
class SEFAdapter(internal var context: Context
                  , internal var sefObject: List<SEFObject>
                  , internal var sefListener: SEFListener) : RecyclerView.Adapter<SEFAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val mLMFObject = sefObject[position].Data
