...
class FTAdapter(internal var context: Context
                , internal var ftObject: List<FTObject>
                , internal var ftListener: FTListener) : RecyclerView.Adapter<FTAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val mTeamObject = ftObject[position].Data
